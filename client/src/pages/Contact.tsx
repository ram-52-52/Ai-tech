    ...
    <div className="min-h-screen bg-white dark:bg-black text-neutral-900 dark:text-white font-plus-jakarta selection:bg-orange-500/30">
      ...
      <div className="max-w-7xl mx-auto pt-40 pb-24 px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative">
        ...
        <div className="relative">
            {isSuccess ? (
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-[3.5rem] p-12 md:p-16 border border-neutral-100 dark:border-neutral-800 text-center space-y-8 animate-fade-in">
                    <div className="w-24 h-24 bg-green-500/10 rounded-full flex items-center justify-center mx-auto">
                        <CheckCircle2 className="w-12 h-12 text-green-500" />
                    </div>
                    <div className="space-y-4">
                        <h2 className="text-3xl font-black text-neutral-900 dark:text-white uppercase tracking-tighter">Inquiry Received</h2>
                    ...
                    <Button 
                        ...
                        className="h-14 px-10 rounded-2xl bg-neutral-900 dark:bg-white text-white dark:text-black font-black uppercase tracking-widest hover:scale-105 transition-all"
                    >
                        Send another message
                    </Button>
                </div>
            ) : (
                <div className="bg-white dark:bg-neutral-950 rounded-[3.5rem] p-10 md:p-16 border border-neutral-200 dark:border-neutral-800 shadow-2xl shadow-orange-500/5 relative overflow-hidden ring-1 ring-neutral-200 dark:ring-white/10">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 relative z-10">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="space-y-3">
                                        ...
                                        <FormControl>
                                            <Input placeholder="John Doe" {...field} className="h-14 bg-neutral-50/50 dark:bg-neutral-900/50 border-neutral-100 dark:border-neutral-800 rounded-2xl px-6 focus:ring-2 focus:ring-orange-500/50 font-bold" />
                                        </FormControl>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="space-y-3">
                                        ...
                                        <FormControl>
                                            <Input placeholder="john@company.com" {...field} className="h-14 bg-neutral-50/50 dark:bg-neutral-900/50 border-neutral-100 dark:border-neutral-800 rounded-2xl px-6 focus:ring-2 focus:ring-orange-500/50 font-bold" />
                                        </FormControl>
                                        <FormMessage className="text-[10px] font-bold text-red-500" />
                                    </FormItem>
                                )}
                            ...
                            <Button 
                                ...
                                className="w-full h-16 rounded-[1.5rem] bg-orange-500 hover:bg-orange-600 text-white font-black uppercase tracking-[0.2em] shadow-xl shadow-orange-500/20 active:scale-95 transition-all text-xs"
                            >
